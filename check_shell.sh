...
time echo -n "afficher si le flux entre la machine est 8.8.8.8 sur le port 443 est ouvert | $(ncat -zv -w 2 255.8.8.8 443 2>&1 | sed -n '2p' | sed 's/[ \t]*Ncat:[ \t]*//g' | sed 's/[ \t]*to.*$//g') | "
